...
// Tactile buttons -> pins 9, 10, 11
// MAX6675 thermocouple -> pins 4, 5, 6 (DO, CS, CLK)
...
const int BUTTON_PIN_1 = 10;       // Tactile button 1
const int BUTTON_PIN_2 = 9;      // Tactile button 2
const int BUTTON_PIN_3 = 11;      // Tactile button 3
